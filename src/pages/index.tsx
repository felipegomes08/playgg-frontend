        ...
        <Flex width="100%" bg="#011627" justify="center" pt="10px">
          ...
          <Flex boxSize="sm" direction="column">
            <Image
              ...
              alt="Segun Adebayo"
            />
            <Text mt="2" color="white" fontWeight="bold">28 SET-05 OUT</Text>
            <Text my="2" color="white">Qui, 07 Out · 14:00</Text>
            <Text my="2" color="white">GAME CUP 2021</Text>
            <Text my="2" color="white">oCeano – Patos de Minas, MG</Text>
            <Button my="2" alignSelf="center" w="120px" bg="blue" color="white">Saiba Mais</Button>
          </Flex>
          <Flex boxSize="sm" direction="column">
            <Image
              height="180px"
              ...
              alt="Segun Adebayo"
            />
            <Text mt="2" color="white" fontWeight="bold">28 SET-10 OUT</Text>
            <Text my="2" color="white">Ter, 12 Out · 14:00</Text>
            <Text my="2" color="white">Cologne 2021 2021</Text>
            <Text my="2" color="white">oCeano – Patos de Minas, MG</Text>
            <Button my="2" alignSelf="center" w="120px" bg="blue" color="white">Saiba Mais</Button>
          </Flex>
          <Flex boxSize="sm" direction="column">
            ...
            />
            <Text mt="2" color="white" fontWeight="bold">28 SET-05 OUT</Text>
            <Text my="2" color="white">Qui, 21 Out · 14:00</Text>
            <Text my="2" color="white">LCK 2021 Spring</Text>
            <Text my="2" color="white">oCeano – Patos de Minas, MG</Text>
            <Button my="2" alignSelf="center" w="120px" bg="blue" color="white">Saiba Mais</Button>
          </Flex>
          <Flex boxSize="sm" direction="column">
            <Image
              ...
              alt="Segun Adebayo"
            />
            <Text mt="2" color="white" fontWeight="bold">28 SET-15 NOV</Text>
            <Text my="2" color="white">Ter, 16 Nov · 14:00</Text>
            <Text my="2" color="white">GAME CUP 2021</Text>
            <Text my="2" color="white">oCeano – Patos de Minas, MG</Text>
            <Button my="2" alignSelf="center" w="120px" bg="blue" color="white">Saiba Mais</Button>
          </Flex>
